...
there are in the file, and print out the results to the screen. I have a .txt file
...
Extra:
    ...
    a bit about string parsing in Python 3
"""


def returnNamesFromFile(openFile, sundata=False):
    names = {}
...
if __name__ == '__main__':
    with open('nameslist.txt') as sourceFile:
        result = returnNamesFromFile(sourceFile)
    print(result)
    with open('Training_01.txt') as sf:
        result = returnNamesFromFile(sf, True)
    print(result)
